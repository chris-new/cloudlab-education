...
node_bridge_1.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_bridge_2.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_bridge_3.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_bridge_4.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
