"""Topology for exercises on SNMP and network security"""
...
node_router_int.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_server.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_router_ext.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
